      ...
      <div className="w-full max-w-md animate-fade-in relative z-10 glass dark:glass-dark rounded-3xl p-8 shadow-xl shadow-zinc-900/5 dark:shadow-black/40">
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex justify-center items-center gap-2 py-3.5 px-4 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors dark:focus:ring-offset-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed"
          >
